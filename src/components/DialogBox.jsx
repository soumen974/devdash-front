              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className={`mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full ${IconName? "bg-green-100" :"bg-red-100" }  sm:mx-0 sm:h-10 sm:w-10`}>
                    {IconName? ( <Check className="h-6 w-6 text-green-600" aria-hidden="true" />):( <TriangleAlert className="h-6 w-6 text-red-600" aria-hidden="true" />)}
                    </div>

...
export default function Navbar() {
  return (
    <>
    <div className="text-white items-center px-3 lg:px-9 py-4 border-b-[1px] border-[#5e5e5e7a] backdrop-blur-2xl bg-gradient-to-b border-neutral-100 from-inherit bg-zinc-800/30 ">

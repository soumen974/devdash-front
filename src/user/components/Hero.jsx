                ...
                <div className="lg:flex  ">
                    <div className="mx-auto  ">
                        ...
                        <div className="text-start pb-6">
                            ...
                            <div className="mt-7 flex justify-end sm:justify-start gap-5">
                                <button className='border  backdrop-blur-sm  border-[#5e5e5e7a] rounded-full px-2 py-2 sm:pr-5 flex gap-2'>
                                    <img className='w-6 h-6 ' src={google} alt="" />
                                   <h1 className='max-sm:hidden'>Sign in With Google</h1> 
                                </button>
                                <button className='border  backdrop-blur-sm  border-[#5e5e5e7a] rounded-full px-2 py-2 sm:pr-5 flex gap-2'>
                                <Github className='h-6 w-6' />
                                    <h1 className='max-sm:hidden'>Sign in Github </h1>
                                </button>
                            </div>

...
const NewPrompt = ({ data }) => {
  ...
  return (
	...
	{question && <div className="bg-[#2c2937] p-3 rounded-[20px] max-w-[80%] self-end">{question}</div>}
	{answer && <div className="p-5 w-[90%]"><Markdown>{answer}</Markdown></div>}
	<div className="pb-24" ref={endRef}></div>
		<form action="" onSubmit={handleSubmit} ref={formRef} className='w-[60%] absolute right-24 bottom-3 bg-[#2c2937] rounded-2xl flex items-center gap-5 py-0 px-5'>
